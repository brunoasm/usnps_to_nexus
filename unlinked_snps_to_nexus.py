...
if __name__ == "__main__":
    ...
    parser.add_argument('-p','--pop-file', help = "optional: path to file with population information. It must be in csv format and contain a column named 'sample' and another named 'population'")
